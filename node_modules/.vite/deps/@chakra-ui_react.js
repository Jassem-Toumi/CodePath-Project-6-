...
function calculateDuration(generator) {
  ...
  return duration >= maxDuration2 ? Infinity : duration;
}
...
function createAcceleratedAnimation(value, valueName, { onUpdate, onComplete, ...options }) {
  ...
  updateFinishedPromise();
  let { keyframes: keyframes3, duration = 300, ease: ease2 } = options;
...
function createAnimationsFromSequence(sequence, { defaultTransition: defaultTransition2 = {}, ...sequenceTransition } = {}, scope) {
  ...
  for (let i = 0; i < sequence.length; i++) {
    ...
    const resolveValueSequence = (valueKeyframes, valueTransition, valueSequence, elementIndex = 0, numElements = 0) => {
      ...
      const { duration = defaultTransition2.duration || 0.3, ease: ease2 = defaultTransition2.ease || "easeOut" } = valueTransition;
